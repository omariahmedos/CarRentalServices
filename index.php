...
<link rel="shortcut icon" href="https://ddac-bucket.s3.amazonaws.com/images/logo.png">
...
<!-- Banners -->
<section id="" class="banner-section" style=" background-image: url('https://ddac-bucket.s3.amazonaws.com/images/blog_img4.jpg'); ">
  <div class="container">
    <div class="div_zindex">
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>We Provide your dream car to you.</h1>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find your Dream <span>Car For You</span></h2>
    ...
    <div class="row"> <?php if (!isset($_SESSION['login'])) {?>
      <div class="col-md-12"> 
	 <center> <div class="login_btn " style="" > <a href="#loginform" class="btn btn-primary " data-toggle="modal" data-dismiss="modal" style="color:white; background: 	#088F8F; border-radius:40px; margin-bottom:10px; padding:18px; ">Sign in / Sign up</a> </div>
	  </center>
	</div> <?php }?>
      <!-- Nav tabs -->
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="" style="border-radius:70px; padding: 10px;"><a href="#resentnewcar" role="tab" data-toggle="tab">New Car Available</a></li>
...
<!-- Fun Facts-->
<section class="fun-facts-section" style="background: gray">
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell" style="background: blue;">
...
<!--Testimonial -->
<section class="section-padding testimonial-section parallex-bg" style="background: wheat;">
  <div class="container div_zindex">
